	...
	<div class="position">
		<div class="positon_L">
			<div class="position_C">
				当前位置：定时任务维护 <span class="posNext"></span><span id="position_add"></span>定时任务
			</div>
		</div>
	</div>
	...
	<div class="tool">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%"
			...
			<tr>
				...
				<td class="tool_C">
					<div class="toolbar">
						<ssi:auth authId="S_JOB_ADD">
							<a class="btnList"><span><span> <input
										onclick="gotoAdd('${ctx}');" type="button" value="新增"
										class="icon iconAdd">
								</span></span></a>
						</ssi:auth>
						<ssi:auth authId="S_JOB_EDIT">
							<a class="btnList"><span><span> <input
										onclick="gotoEdit('${ctx}');" type="button" value="修改"
										class="icon iconEdit" single-edit=true>
								</span></span></a>
						</ssi:auth>
						<ssi:auth authId="S_JOB_DEL">
							<a class="btnList"><span><span> <input
										onclick="gotoDel('${ctx}');" type="button" value="删除"
										class="icon iconDel">
								</span></span></a>
						</ssi:auth>
						<ssi:auth authId="S_JOB_START">
							<a class="btnList"><span><span> <input
										onclick="gotoStart('${ctx}');" type="button" value="启动"
										class="icon">
								</span></span></a>
						</ssi:auth>
						<ssi:auth authId="S_JOB_STOP">
							<a class="btnList"><span><span> <input
										onclick="gotoStop('${ctx}');" type="button" value="停止"
										class="icon">
								</span></span></a>
						</ssi:auth>
						<a class="btnList" href="http://www.bejson.com/cronCreator/"
							target="_blank"><span><span> <input
									type="button" value="Cron" class="icon">
							...
							<td class="searchTd">
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td class="inputTd"><input name="formMap.DES"
											id="SEARCH_DES" value="${formMap.DES}" type="text"
											class="input100"></td>
