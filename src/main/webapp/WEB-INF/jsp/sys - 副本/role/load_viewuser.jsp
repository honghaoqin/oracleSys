...
<div class="pnlForm">
	<div class="pnlHead">
		<div class="pnlHead_L">
			<div class="pnlHead_C">
				<div class="pnlTitle">
					<a class="switchBtn" onClick="javascript:sHlay(this,'hidden');"></a>查看已分配权限
				</div>
		...
		<div class="pnlContent optionBar2">
			<div class="tableFix">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td class="inputTd">
							<!--begin: 祥表内容--> <input type="hidden" name="formMap.ROLE_ID"
							value="${formMap.ROLE_ID}">
							<div style="height: 500px; overflow: auto" class="treeview">
								<ul>
