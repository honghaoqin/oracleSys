...
<!-- UI Structure Begin "用户修改" -->
<div class="pnlForm">
	<div class="pnlHead">
		<div class="pnlHead_L">
			<div class="pnlHead_C">
				<div class="pnlTitle">
					<a class="switchBtn" onClick="javascript:sHlay(this,'hidden');"></a>用户修改
				</div>
	...
	<div class="pnlBody">
		<div class="pnlContent optionBar2">
			<div class="tableFix">
				<input type="hidden" name="formMap.USER_ID"
					value="${resultMap.USER_ID}" />
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td class="labelTd"><em>*</em>所属机构</td>
						  <td class="inputTd"><input type="hidden" id="DEPT_ID"
							...
							value="${resultMap.DEPT_ID_NAME}"> <a class="btnSearch"><span><span>
					...
					<tr>
						...
						<td class="inputTd"><input name="formMap.PAGE_SIZE"
