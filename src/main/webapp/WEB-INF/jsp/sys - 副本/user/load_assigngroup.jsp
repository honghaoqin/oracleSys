...
<%@ include file="/commons/taglibs.jsp"%>
	...
	<div class="pnlForm">
		<div class="pnlHead">
			<div class="pnlHead_L">
				<div class="pnlHead_C">
					<div class="pnlTitle"><a class="switchBtn" onClick="javascript:sHlay(this,'hidden');"></a>用户组分配</div>
		...
		<div class="pnlBody">
			<div class="pnlContent">
				<!-- UI Structure Begin "信息列表表格" -->
				  <input type="hidden" name="formMap.USER_ID" id="USER_ID" value="${formMap.USER_ID}">
							...
							<s:if test="resultList.size!=0">
								<s:iterator value="resultList" id="row" status="st">
									<tr <s:if test="#st.index%2!=0">class="oddRow"</s:if>
										...
										name="formMap.GROUP_ID" class="IDSS" value="${row.GROUP_ID}">
										</td>
