	...
	<div class="position">
		<div class="positon_L">
			<div class="position_C">
				当前位置：字典维护 <span class="posNext"></span><span id="position_add"></span>字典
			</div>
		</div>
	</div>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td class="inputTd"><input type="hidden"
											name="formMap.TYPE_OP" value="=" /> <select
											class="select100" name="formMap.TYPE" id="SEARCH_TYPE">
												<option></option>
												<ssi:select value="${formMap.TYPE}" type="dicttype" />
										</select></td>
										<td class="labelTd" width="120">值</td>
										<td class="inputTd"><input name="formMap.VALUE"
											id="SEARCH_VALUE" value="${formMap.VALUE}" class="input100"
											class="input100" type="text" maxlength="100" /></td>
										<td>文本</td>
										<td><input name="formMap.TEXT" id="SEARCH_TEXT"
											value="${formMap.TEXT}" type="text" class="input100"></td>
