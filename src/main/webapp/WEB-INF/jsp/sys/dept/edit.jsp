...
<body>
	<article class="page-container">
		<form action="${ctx}/sys/Dept/edit.do" method="post"
		...
		<input type="hidden" name="formMap.DEPT_ID"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="hidden" id="PARENT_ID"  name="formMap.PARENT_ID" value="${resultMap.PARENT_ID}"> 
					<input  type="text" id="PARENT_NAME" class="input-text" readonly="readonly"
					 name="formMap.PARENT_NAME" value="${resultMap.PARENT_NAME}"> <a class="btnSearch"><span><span>
