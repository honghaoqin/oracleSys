...
<div id="task-properties-layout" class="easyui-layout" fit="true">
	...
	<div id="task-properties-panel" region="center" border="true">
		<div id="task-properties-accordion" class="easyui-accordion" fit="true" border="false">
			<div id="general" title="主配置" selected="true" class="properties-menu">
				<table id="general-properties">
					...
					<tr>
						...
						<td>
						<input type="text" id="scriptFormat" name="scriptFormat" size="28" value=""/>
						</td>
					</tr>
					<tr>
						<td align="right">返回变量:</td>
						<td>
						<input type="text" id="resultVariable" name="resultVariable" size="28" value=""/>
						</td>
					</tr>
					<tr>
						<td align="right">脚本:</td>
						<td>
						<textarea name="expression" id="expression" rows="10" cols="25"/>
						</td>
					</tr>
				</table>
			</div>
