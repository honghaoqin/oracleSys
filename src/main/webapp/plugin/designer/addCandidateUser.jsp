       ...
       <table id="task-unselect-candidate-user-list">
			<thead>
				<tr>
					...
					<th field="sso" width="80" align="middle" sortable="true">SSO</th>
					<th field="name" width="100" align="middle" sortable="true">姓名</th>
					<th field="title" width="100" align="middle" sortable="true">Title</th>
					<th field="email" width="200" align="middle">Email</th>
					<th field="userStatus" width="200" align="middle">状态</th>
				</tr>
			</thead>
			<tbody>
			<tr>
