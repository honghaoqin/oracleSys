...
public class ImageUtil {
   ...
   public ImageUtil(String srcFile,String destFile) throws IOException {
    ...
    // this.srcFile = _file.getName();
     this.destFile =destFile;//this.srcFile.substring(0, this.srcFile.lastIndexOf(".")) +"_s.jpg";
     img = javax.imageio.ImageIO.read(_file); //构造Image对象
     width = img.getWidth(null); //得到源图宽
     height = img.getHeight(null); //得到源图长
   }
   public ImageUtil(File srcFile,String destFile) throws IOException {
	    this.destFile =destFile;//this.srcFile.substring(0, this.srcFile.lastIndexOf(".")) +"_s.jpg";
	     img = javax.imageio.ImageIO.read(srcFile); //构造Image对象
	     width = img.getWidth(null); //得到源图宽
	     height = img.getHeight(null); //得到源图长
	   }
   /**
   ...
   public static void main(String[] args) {
	   try {
		new  ImageUtil("D:/apache_tomcat/ftpServer/ftproot/1.jpg","D:/apache_tomcat/ftpServer/ftproot/3.jpg").resizeByWidth(400);
